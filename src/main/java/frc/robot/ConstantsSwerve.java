...
public final class ConstantsSwerve {
    public static final String swerveCANBusDeviceName = "Drivetrain";
    ...
    public static final double trackWidth = Units.inchesToMeters(19); // meters
    public static final double wheelBase = Units.inchesToMeters(28.875); // meters
    public static final double wheelCircumference = chosenModule.wheelCircumference; // meters
    public static final double robotWeightKg = 49.44; // kg
    /*
     * Swerve Kinematics
    ...
    public static final double openLoopRamp = 0.5; // These values are used by the drive falcon to ramp in open loop
                                                   // and closed loop driving.
    public static final double closedLoopRamp = 0.5; // A small open loop ramp (0.25) helps with tread wear,
                                                     // tipping, etc
    public static final double JitterCutoff = 0.015; // jitter cutoff value to stop the motors from turning at low
                                                     // speeds and being unable to start due to low starting torque

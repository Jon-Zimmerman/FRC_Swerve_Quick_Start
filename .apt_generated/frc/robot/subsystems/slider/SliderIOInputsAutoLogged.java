...
public class SliderIOInputsAutoLogged extends SliderIO.SliderIOInputs implements LoggableInputs, Cloneable {
  @Override
  ...
  public SliderIOInputsAutoLogged clone() {
    SliderIOInputsAutoLogged copy = new SliderIOInputsAutoLogged();
